 ...
 */
public class MultiPolyOrthognalTiled extends BatchTiledMapRenderer {

	public MultiPolyOrthognalTiled(TiledMap map) {
		this(map, new PolygonSpriteBatch());
		this.ownsBatch = true;
	}

	public MultiPolyOrthognalTiled(TiledMap map, PolygonSpriteBatch batch) {
		super(map, batch);
	}

	public MultiPolyOrthognalTiled(TiledMap map, float unitScale) {
		this(map, unitScale, new PolygonSpriteBatch());
		this.ownsBatch = true;
	}

	public MultiPolyOrthognalTiled(TiledMap map, float unitScale, PolygonSpriteBatch batch) {
