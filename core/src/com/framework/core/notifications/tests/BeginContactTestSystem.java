...
public class BeginContactTestSystem extends IteratingSystem implements ContactEventSubscriber {
    ...
    protected void processEntity(Entity entity, float dt) {
        // System.out.println("START contact between " + contactEvent.getTypeB() + " and " + contactEvent.getTypeA());
